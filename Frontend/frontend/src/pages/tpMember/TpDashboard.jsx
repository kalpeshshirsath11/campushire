...
const TpDashboard = () => {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        // Fetch applications from active drives report
        const applicationsResponse = await axiosClient.get('/applications/reports').catch(() => ({ data: { success: false, data: [] } }));
        ...
        const appsList = applicationsResponse.data?.success ? applicationsResponse.data.data : [];
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-2xl font-bold text-white mb-1">TP Member Operations Dashboard</h2>
        <p className="text-text-low text-sm">Review student verifications and coordinate placement status trackers.</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="glass-card rounded-xl p-6 flex justify-between items-center relative overflow-hidden">
          ...
          <div>
            <span className="text-[10px] font-bold text-text-low uppercase tracking-wider block mb-1">Total Students</span>
        ...
        <div className="glass-card rounded-xl p-6 flex justify-between items-center relative overflow-hidden">
          ...
          <div>
            <span className="text-[10px] font-bold text-text-low uppercase tracking-wider block mb-1">Companies</span>
        ...
        <div className="glass-card rounded-xl p-6 flex justify-between items-center relative overflow-hidden">
          ...
          <div>
            <span className="text-[10px] font-bold text-text-low uppercase tracking-wider block mb-1">Active Drives</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex justify-between items-center">
            ...
            >
              Update Stages <ChevronRight size={14} />
            </Link>
          </div>
        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          <div className="glass-card rounded-xl p-5 space-y-3.5 border-l-4 border-brand-cyan bg-brand-cyan/5">
            <span className="text-xs font-semibold text-white block">Pending Student Approvals</span>
            <p className="text-text-medium text-xs leading-relaxed">
              Verify credentials and Drive documents uploaded by students to approve their job application eligibility.
            </p>
            <Link 
              to="/tp/verify"
